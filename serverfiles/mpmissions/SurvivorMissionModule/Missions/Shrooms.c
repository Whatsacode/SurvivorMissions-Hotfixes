class ShroomsMission extends SurvivorMissions
{
	...
	{	
		...
		m_MissionMessage2 = "At the moment, I am experimenting with the psychoactive substance psilocybin on infected wild animals. The animals begin to show unusual behavior about 30 minutes after oral intake. I can't say much yet, but for my experiments I need more mushrooms.";
