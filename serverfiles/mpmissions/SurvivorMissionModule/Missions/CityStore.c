...
{	//CityStore is a copy of UrbanMall mission, it uses another secondary mission building
	...
	{		
		...
		m_MissionMessage2 = "Yesterday, I learned that the city store\n** " + m_MissionLocationDir + " of " + m_MissionLocation + " **\nis barricaded and probably still has some food inside. But there were too many infected around, so I wasn't able to check the supermarket.";
    ...
    {    
        ...
        string name = "City Store PVP Zone";
